#!/bin/bash
powerstat -z -d 0 0.5 960 >> 20_pstat4.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 40_pstat4.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 60_pstat4.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 80_pstat4.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 100_pstat4.out &
sleep 60;
