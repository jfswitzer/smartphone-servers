#!/bin/bash
powerstat -z -d 0 0.5 960 >> 20_pstat3.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 40_pstat3.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 60_pstat3.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 80_pstat3.out &
sleep 60;
...
powerstat -z -d 0 0.5 960 >> 100_pstat3.out &
sleep 60;
